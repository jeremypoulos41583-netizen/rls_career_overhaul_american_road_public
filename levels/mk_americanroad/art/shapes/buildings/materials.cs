...
singleton Material(ind_bld_Tin_01)
{
    ...
    diffuseMap[0] = "levels/mk_americanroad/art/shapes/buildings/tin-01_d.dds";
    doubleSided = "0";
    translucentBlendOp = "None";
    specularMap[0] = "levels/mk_americanroad/art/shapes/buildings/tin-01_s.dds";
    materialTag0 = "Industrial";
    detailMap[0] = "levels/mk_americanroad/art/shapes/buildings/detail_grunge_02_streak.dds";
    detailScale[0] = "0.1 0.1";
    normalMap[0] = "levels/mk_americanroad/art/shapes/buildings/tin-01_n.dds";
    specularPower[0] = "1";
    useAnisotropic[0] = "1";
    materialTag1 = "beamng";
	annotation = "BUILDINGS";
...
singleton Material(ind_bld_extras)
{
    ...
    specularPower[0] = "1";
    pixelSpecular[0] = "1";
    specularMap[0] = "levels/mk_americanroad/art/shapes/buildings/ind_bld_buildingextras_s.dds";
    materialTag0 = "beamng";
    materialTag1 = "beamng";
    materialTag2 = "Industrial";
   colorMap[0] = "levels/mk_americanroad/art/shapes/buildings/ind_bld_buildingextras_d.dds";
   normalMap[0] = "levels/mk_americanroad/art/shapes/buildings/ind_bld_buildingextras_n.dds";
   specularStrength0 = "1.3";
	annotation = "BUILDINGS";
};

singleton Material(ind_bld_extras_annotation_background)
{
    mapTo = "ind_bld_extras_annotation_background";
    doubleSided = "0";
    translucentBlendOp = "None";
    specularPower[0] = "1";
    pixelSpecular[0] = "1";
...
singleton Material(ind_bld_brick_01)
{
    ...
    detailMap[0] = "levels/mk_americanroad/art/shapes/buildings/detail_grunge_02b.dds";
...
singleton Material(ind_bld_rustymetal_01)
{
    ...
    detailMap[0] = "levels/mk_americanroad/art/shapes/buildings/detail_grunge_02.dds";
    detailScale[0] = "0.1 0.1";
...
singleton Material(Asphalt_road_01_decal2)
{
    ...
    diffuseMap[0] = "levels/mk_americanroad/art/road/AsphaltRoad_decal_02.dds";
    useAnisotropic[0] = "1";
    castShadows = "0";
    translucent = "1";
    translucentZWrite = "1";
...
singleton Material(ind_bld_concrete)
{
    ...
    materialTag0 = "beamng";
    useAnisotropic[0] = "1";
    detailMap[0] = "levels/mk_americanroad/art/shapes/buildings/detail_grunge_03.dds";
	annotation = "BUILDINGS";
};
...
singleton Material(pier_support)
{
    ...
    doubleSided = "1";
    translucentBlendOp = "None";
    diffuseMap[0] = "levels/mk_americanroad/art/shapes/buildings/wood_01_d.dds";
    detailScale[0] = "0.1 0.1";
    detailNormalMapStrength[0] = "1";
    specularMap[0] = "levels/mk_americanroad/art/shapes/buildings/wood_01_s.dds";
    normalMap[0] = "levels/mk_americanroad/art/shapes/buildings/wood_01_n.dds";
    detailMap[0] = "levels/mk_americanroad/art/shapes/buildings/ruinedpier_support_d.dds";
	annotation = "BUILDINGS";
};
...
singleton Material(wood_01)
{
    ...
    specularMap[0] = "levels/mk_americanroad/art/shapes/buildings/wood_01_s.dds";
    normalMap[0] = "levels/mk_americanroad/art/shapes/buildings/wood_01_n.dds";
    detailMap[0] = "levels/mk_americanroad/art/shapes/buildings/wood_01_overlay.dds";
	annotation = "BUILDINGS";
};
...
singleton Material(littleboat_01_ab)
{
    ...
    doubleSided = "1";
    translucentBlendOp = "None";
    diffuseMap[0] = "levels/mk_americanroad/art/shapes/buildings/littleboat_01_ab_d.dds";
    detailScale[0] = "8 8";
    detailNormalMapStrength[0] = "0.5";
    detailMap[0] = "levels/mk_americanroad/art/shapes/buildings/wood_01_d.dds";
    detailNormalMap[0] = "levels/mk_americanroad/art/shapes/buildings/wood_01_n.dds";
    normalMap[0] = "levels/mk_americanroad/art/shapes/buildings/littleboat_01_ab_n.dds";
    specularMap[0] = "levels/mk_americanroad/art/shapes/buildings/littleboat_01_ab_s.dds";
    materialTag0 = "beamng";
